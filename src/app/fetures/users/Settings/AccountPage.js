  ...
  return (
    ...
    <div>
        ...
        <Form  onSubmit={handleSubmit(updatePassword)}>
          ...
          <Button size="large" positive disabled={invalid || submitting} content="Update Password" />
        </Form>
      </div>}
...
const validate=combineValidators({
    newPassword1:isRequired({message:'New Password is requred'}),
    newPassword2:composeValidators(
        isRequired({message:'Confirm Password is requred'}),
...
export default reduxForm({ form: 'account',validate,enableReinitialize:true })(AccountPage);