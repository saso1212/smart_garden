    ...
    <Segment>
      ...
      <Form onSubmit={handleSubmit(updateProfile)}>
        ...
        component={TextArea}
         ...
         {/* if we wabt to query in firebase we cant not because in fiestroe we can not 
        filter or something arry so we must change to object but if we want tio u se onlu as a data
        we can store in array */}
        <Field
          name="interests"
