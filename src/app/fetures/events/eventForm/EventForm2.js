...
class EventForm2 extends Component {
  state={
    cityLatLng: {},
    venueLatLng: {},
    scriptLoaded: false,
...
export default withFirestore (connect(mapStateToProp,mapDispatchToProps)(reduxForm({form: 'eventForm2',enableReinitialize:true,validate})(EventForm2)));